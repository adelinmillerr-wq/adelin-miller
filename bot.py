...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Lava.top кнопки
    keyboard.append([InlineKeyboardButton("🧪 Тест ЮMoney — 50 руб", url=make_ym_url(chat_id, 3))])
    keyboard.append([InlineKeyboardButton("💛 1 месяц — 690 руб (ЮMoney)", url=make_ym_url(chat_id, 1))])
    keyboard.append([InlineKeyboardButton("💛 Навсегда — 8990 руб (ЮMoney)", url=make_ym_url(chat_id, 2))])
