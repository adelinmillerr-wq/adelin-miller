...
# Исправленные красивые и рабочие ссылки на формы оплаты твоих виджетов
LAVA_URLS = {
    1: 'https://widget.lava.top/products/cd4f69b5-6817-4b5a-bec6-c08aa94c6b68',
    2: 'https://widget.lava.top/products/1a45306a-2ce1-428b-9f7d-375736bed15b',
    3: 'https://widget.lava.top/products/c77b5806-7a38-474f-be08-18c45e25b449',
}
...
def lavatop_result():
    ...
    # Безопасно вытягиваем utm_content из структуры ответа
