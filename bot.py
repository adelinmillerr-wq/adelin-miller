...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("1 месяц — 690 руб", url=url1)],
        [InlineKeyboardButton("Навсегда — 8990 руб (АКЦИЯ)", url=url2)],
    ]

    text = (
        "Привет! Я помогу получить доступ в закрытый канал Adelin Creator Space\n\n"
        "1 месяц — 690 руб\n"
