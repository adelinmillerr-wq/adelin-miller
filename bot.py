...
TARIFFS = {
    ...
    2: {'name': '3 месяца',   'price': 2070, 'days': 90},
    3: {'name': '6 месяцев',  'price': 4140, 'days': 180},
    4: {'name': 'Навсегда',   'price': 8990, 'days': None},
}
...
LAVA_URLS = {
    ...
    2: 'https://app.lava.top/products/d3fd9467-c625-4b2f-a8f0-332f6a9e174a/24e3dbc6-4339-4000-9835-ce31b2ade2d5',
    3: 'https://app.lava.top/products/d3fd9467-c625-4b2f-a8f0-332f6a9e174a/24e3dbc6-4339-4000-9835-ce31b2ade2d5',
    4: 'https://app.lava.top/products/9e4d87ed-31cb-4393-88bc-04d7e207aaee',
}
...
@app.route('/lavatop/result', methods=['POST'])
def lavatop_result():
...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        url_crypto4, _ = create_crypto_invoice(chat_id, 4)
    except Exception as e:
    ...
    # Lava.top кнопки
    keyboard.append([InlineKeyboardButton("💜 1 месяц — 690 руб", url=make_lava_url(chat_id, 1))])
    keyboard.append([InlineKeyboardButton("💜 3 месяца — 2070 руб", url=make_lava_url(chat_id, 2))])
    keyboard.append([InlineKeyboardButton("💜 6 месяцев — 4140 руб", url=make_lava_url(chat_id, 3))])
    keyboard.append([InlineKeyboardButton("💜 Навсегда — 8990 руб", url=make_lava_url(chat_id, 4))])
...
⚠️ Отмена подписки: app.lava.top → Мои покупки → Подписки → Отменить
После отмены ты потеряешь доступ к клубу и зафиксированную цену навсегда. При повторной покупке цена будет выше 🙂"
    )
